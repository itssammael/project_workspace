...
<template>
    <div :class="'theme-' + ($page.props.settings?.theme || 'corporate_teal')">
        <Head :title="'Welcome - ' + ($page.props.settings?.system_name || 'Project Tracker')" />
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" />
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex flex-col items-center justify-center lg:col-start-2 space-y-2">
                            <img v-if="$page.props.settings?.logo" :src="$page.props.settings.logo" class="h-16 w-auto object-contain rounded-md" />
                            <svg v-else viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-[var(--brand-primary)] fill-current">
                            ...
                            <span class="font-extrabold text-2xl text-gray-900 theme-text-primary leading-none">
