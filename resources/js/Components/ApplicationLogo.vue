...
<template>
    <div class="flex items-center space-x-3">
        <img v-if="page.props.settings?.logo" :src="page.props.settings.logo" class="h-12 w-auto object-contain rounded-md" />
        <svg v-else viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-[var(--brand-primary)] fill-current">
        ...
        <span class="font-bold text-xl text-gray-900 theme-text-primary leading-none">
