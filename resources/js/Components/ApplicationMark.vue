...
<template>
    <img v-if="page.props.settings?.logo" :src="page.props.settings.logo" class="h-9 w-auto object-contain rounded-md" />
    <svg v-else viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-[var(--brand-primary)] fill-current">
